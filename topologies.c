...
build_linear_topo(void)
{
            ...
            +-----------+                             +-----------+                          +-----------+
            |           |10.1.1.1/24            eth0/2|           |eth0/3         11.1.1.1/24|           |
            +    R1     +-----------------------------+    R2     +--------------------------+    R3     +
            | 122.1.1.1 |eth0/1            10.1.1.2/24| 122.1.1.2 |11.1.1.2/24         eth0/4| 122.1.1.3 |
            +-----------+                             +-----------+                          +-----------+
    ...
    insert_link_bw_two_nodes(R1, R2, "eth0/1", "eth0/2", 1);
    insert_link_bw_two_nodes(R2, R3, "eth0/3", "eth0/4", 1);
...
build_square_topo(void)
{
            ...
            +-----------+                             +-----------+                          +-----------+
            |           |10.1.1.1/24            eth0/1|           |eth0/2         20.1.1.2/24|           |
            +    R1     +-----------------------------+    R2     +--------------------------+    R3     +
            | 122.1.1.1 |eth0/0            10.1.1.2/24| 122.1.1.2 |20.1.1.1/24         eth0/3| 122.1.1.3 |
            +-----------+                             +-----------+                          +-----------+
      40.1.1.2/24 | eth0/7                                                              30.1.1.1/24 | eth0/4
                  |                                                                                 |
                  |                                                                                 |
                  |                                                                                 |
                  |                                     +-----------+                               |
    ...
    insert_link_bw_two_nodes(R1, R2, "eth0/0", "eth0/1", 1);
    insert_link_bw_two_nodes(R2, R3, "eth0/2", "eth0/3", 1);
    insert_link_bw_two_nodes(R3, R4, "eth0/4", "eth0/5", 1);
    insert_link_bw_two_nodes(R4, R1, "eth0/6", "eth0/7", 1);
...
build_simple_l2_switch_topo(void)
{
                                                 ...
                                                 +-----------+
                +-----------+                    |           |                   +-----------+
                |           |10.1.1.2/24         |           |eth0/2  10.1.1.1/24|           |
                +    H1     +--------------------+   L2Sw    +-------------------+    H3     +
                | 122.1.1.1 |eth0/5        eth0/4|           |             eth0/6| 122.1.1.3 |
                +-----------+                    |           |                   +-----------+
                                                 +-----------+
                                                       |eth0/3
                                                       |
...
build_dualswitch_topo()
{
                               ...
                               | 122.1.1.2 |                              | 122.1.1.5 |
                               +-----------+                              +-----------+
                                eth0/3| 10.1.1.2/24                              |eth0/8 - 10.1.1.5/24
                                      |                                          |
    ...
    +    H1     +---------------+   L2Sw1   +---------------------------+   L2Sw2   +------------------|           |
    | 122.1.1.1 |eth0/1  eth0/2 |           | TR, V10, V11  TR, V10, V11|           |AC,V10 10.1.1.6/24+    H6     +
    +-----------+       AC, V10 |           |                           |           |                  | 122.1.1.6 |
                                +-----------+                           +-----------+                  +-----------+
                                    |eth0/6                                    |eth0/12
                                    |AC, V11                                   |AC, V11
    ...
    insert_link_bw_two_nodes(H5, L2SW2, "eth0/8", "eth0/9", 1);
